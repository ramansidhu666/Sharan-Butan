        ...
        <div class="property_top_inner_bg">
            ...
            <div class="col-md-5 col-sm-5">
                ...
                <div class="print_button">
                      <div class="print_clr">
                          <asp:Button ID="btnprint" Visible="false" ValidationGroup="newbutton" runat="server" Text="Print" OnClientClick="PrintDiv()" />
                ...
                <asp:Panel ID="pnlImages">
                    <div class="col-md-7 col-sm-7">
                        <div class="seaarch_Property_slider_new_demo">
                          ...
                          <div class="print_button_new">
                            <div class="print_clr22">
                                  <asp:Button ID="Button1" Visible="false" ValidationGroup="newbutton" runat="server" Text="Print" OnClientClick="PrintDiv()" />
                             <%--   <button id="btnprint2" onclick="PrintDiv()">Print</button>--%>
                            </div>
                        </div>
                ...
                <div class="new_detail_bg">
                    ...
                    <div class="detail_left_section_new">
                        <div>
                            ...
                            <asp:Label ID="lblfronting" runat="server" Text="" CssClass="margin-left-10"></asp:Label>&nbsp
                    ...
                    <div class="col-md-8 col-sm-8">
                        <div class="roco_cnts_us">
                            ...
                            <div class="agent_input_prprty_dtl">
                                ...
                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator5" ValidationGroup="FreeHome" ForeColor="Red" runat="server" Display="Dynamic" ControlToValidate="txtFirstName" ErrorMessage="FirstName required" SetFocusOnError="true"></asp:RequiredFieldValidator>--%>
                            ...
                            <div class="agent_input_prprty_dtl">
                                <p>
                                    E-mail: <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ValidationGroup="SaveContactInfo" Display="Dynamic" ControlToValidate="txtEmail" ErrorMessage="*" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </p>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="agent_input_prprty_dtl">
                                        <p>
                                            Phone Number:   
                                             <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ValidationGroup="SaveContactInfo" Display="Dynamic" ControlToValidate="txtPhoneno" ErrorMessage="*" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </p>
